...
Quand une decision devient durable, elle doit etre refletee soit dans ces docs, soit dans `GUIDELINES_AI.md` si elle concerne directement les agents contributeurs.
