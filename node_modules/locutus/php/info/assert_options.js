...
exports.assert_options = assert_options;
const ini_get_ts_1 = require("./ini_get.js");
function assert_options(what, _value) {
    ...
    const iniVal = (0, ini_get_ts_1.ini_get)(iniKey);
