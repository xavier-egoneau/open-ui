...
function base64_encode(stringToEncode) {
    ...
    const bufferValue = (0, _phpRuntimeState_ts_1.getPhpGlobalEntry)('Buffer');
    if ((0, _phpTypes_ts_1.isObjectLike)(bufferValue)) {
        const bufferFrom = (0, _phpRuntimeState_ts_1.getPhpObjectEntry)(bufferValue, 'from');
        if ((0, _phpTypes_ts_1.isPhpCallable)(bufferFrom)) {
            const encoded = bufferFrom.call(bufferValue, String(stringToEncode));
            if (typeof encoded === 'object' && encoded !== null) {
                const encodedToString = (0, _phpRuntimeState_ts_1.getPhpObjectEntry)(encoded, 'toString');
                if ((0, _phpTypes_ts_1.isPhpCallable)(encodedToString)) {
    ...
    const btoaValue = (0, _phpRuntimeState_ts_1.getPhpGlobalCallable)('btoa');
    if (btoaValue) {
