...
const getenv_ts_1 = require("../info/getenv.js");
const isLocaleDefinitionMap = (value) => typeof value === 'object' && value !== null && !Array.isArray(value);
const isLocaleCategoryMap = (value) => (0, _phpTypes_ts_1.isPhpAssocObject)(value) &&
...
function setlocale(category, locale) {
    ...
    const localesValue = (0, _phpRuntimeState_ts_1.getPhpRuntimeEntry)('locales');
    let locales = isLocaleDefinitionMap(localesValue) ? localesValue : {};
    if (localesValue !== locales) {
        (0, _phpRuntimeState_ts_1.setPhpRuntimeEntry)('locales', locales);
    }
    ...
    let currentLocale = (0, _phpRuntimeState_ts_1.getPhpRuntimeString)('locale', '');
    if (!currentLocale) {
        currentLocale = 'en_US';
    ...
    (0, _phpRuntimeState_ts_1.setPhpRuntimeEntry)('locale', currentLocale);
    const localeCategoriesValue = (0, _phpRuntimeState_ts_1.getPhpRuntimeEntry)('localeCategories');
    ...
    if (localeCategoriesValue !== localeCategories) {
        (0, _phpRuntimeState_ts_1.setPhpRuntimeEntry)('localeCategories', localeCategories);
    }
    let requestedLocale = locale;
    if (requestedLocale === null || requestedLocale === '') {
        requestedLocale = (0, getenv_ts_1.getenv)(category) || (0, getenv_ts_1.getenv)('LANG');
    }
