...
exports.nl_langinfo = nl_langinfo;
...
const isLocaleTime = (value) => isStringArray(value, 'a') &&
...
function nl_langinfo(item) {
    ...
    //   returns 1: 'Sunday'
    (0, setlocale_ts_1.setlocale)('LC_ALL', 0); // Ensure locale data is available
    const toValue = (value) => typeof value === 'string' || Array.isArray(value) ? value : false;
    const localeFor = (category) => {
        const localeGroup = (0, _phpRuntimeState_ts_1.getPhpLocaleGroup)(category, category);
