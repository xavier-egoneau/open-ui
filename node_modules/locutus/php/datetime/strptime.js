...
function strptime(dateStr, format) {
    ...
    */
    ...
    const lcTimeGroup = (0, _phpRuntimeState_ts_1.getPhpLocaleGroup)('LC_TIME', 'LC_TIME');
    ...
    while (/%[cDFhnrRtTxX]/.test(format)) {
        format = format.replace(/%([cDFhnrRtTxX])/g, function (_m0, m1) {
    ...
    const _addNext = function (index, regex, cb) {
    ...
    const _addLocalized = function (index, formatChar, category) {
