...
exports.natcasesort = natcasesort;
const ini_get_ts_1 = require("../info/ini_get.js");
const strnatcasecmp_ts_1 = require("../strings/strnatcasecmp.js");
function natcasesort(inputArr) {
    ...
    let populateArr = {};
    const iniVal = (0, ini_get_ts_1.ini_get)('locutus.sortByReference') || 'on';
    ...
    valArr.sort(function (a, b) {
        return Number((0, strnatcasecmp_ts_1.strnatcasecmp)(a[1], b[1]) ?? 0);
    });
