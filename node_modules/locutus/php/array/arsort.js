...
exports.arsort = arsort;
const _phpRuntimeState_ts_1 = require("../_helpers/_phpRuntimeState.js");
const i18n_loc_get_default_ts_1 = require("../i18n/i18n_loc_get_default.js");
const strnatcmp_ts_1 = require("../strings/strnatcmp.js");
...
function arsort(inputArr, sortFlags) {
    ...
    switch (sortFlags) {
        case 'SORT_STRING':
            sorter = (a, b) => Number((0, strnatcmp_ts_1.strnatcmp)(b, a) ?? 0);
            break;
        case 'SORT_LOCALE_STRING': {
            const locale = runtime.locales[(0, i18n_loc_get_default_ts_1.i18n_loc_get_default)()];
            if (locale?.sorting) {
