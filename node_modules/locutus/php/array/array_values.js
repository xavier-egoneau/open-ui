...
const describeArrayValuesArgument = (value) => {
...
function array_values(input) {
    ...
    if (typeof input !== 'object' || input === null || isBoxedScalar(input)) {
        throw new TypeError(`array_values(): Argument #1 ($array) must be of type array, ${describeArrayValuesArgument(input)} given`);
    }
