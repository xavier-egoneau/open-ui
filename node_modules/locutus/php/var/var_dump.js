...
const echo_ts_1 = require("../strings/echo.js");
const hasNodeName = (value) => {
...
const isLocutusResource = (value, getFuncName) => {
    ...
    const varDump = (0, _phpRuntimeState_ts_1.getPhpObjectEntry)(maybeResource, 'var_dump');
    const constructorValue = (0, _phpRuntimeState_ts_1.getPhpObjectEntry)(maybeResource, 'constructor');
    return (typeof varDump === 'function' &&
...
function var_dump(...args) {
    ...
    const _formatArray = function (obj, curDepth, padVal, padChar, visitedObjectMap) {
        ...
        if (typeof obj === 'object' && obj !== null) {
            ...
            let lgth = 0;
            const objRecord = (0, _phpTypes_ts_1.toPhpArrayObject)(obj);
