...
const ini_get_ts_1 = require("../info/ini_get.js");
const hasNumericLength = (value) => value !== null && typeof value === 'object' && typeof (0, _phpRuntimeState_ts_1.getPhpObjectEntry)(value, 'length') === 'number';
function is_array(mixedVar) {
    ...
    const iniVal = (0, ini_get_ts_1.ini_get)('locutus.objectsAsArrays') || 'on';
    if (iniVal === 'on') {
        const asString = Object.prototype.toString.call(mixedVar);
        const asFunc = _getFuncName((0, _phpRuntimeState_ts_1.getPhpObjectEntry)(mixedVar, 'constructor'));
