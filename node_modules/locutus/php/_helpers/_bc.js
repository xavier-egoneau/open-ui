            ...
            */
            ...
            if (!zero) {
                ...
                while (qdig <= len1 + scale - len2) {
                    ...
                    // Test qguess.
                    if (digitAt(n2.n_value, n2ptr + 1) * qguess >
...
function _bc() {
    // original by: lmeyrick (https://sourceforge.net/projects/bcmath-js/)
    // improved by: Brett Zamir (https://brett-zamir.me)
    const existing = (0, _phpRuntimeState_ts_1.getPhpRuntimeEntry)('bcMathLib');
    if (isBcLibrary(existing)) {
        return existing;
    }
    const library = createBcLibrary();
    (0, _phpRuntimeState_ts_1.setPhpRuntimeEntry)('bcMathLib', library);
    return library;
}
