import { resolvePhpCallable } from "../_helpers/_callbackResolver.js";
import { ensurePhpRuntimeState } from "../_helpers/_phpRuntimeState.js";
export function uksort(inputArr, sorter) {
    ...
    if (sorter) {
        ...
        if (typeof sorter === 'string') {
            ...
            const scopeValue = typeof scopeDescriptor === 'string'
