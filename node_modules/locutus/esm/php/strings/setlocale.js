import { getPhpRuntimeEntry, getPhpRuntimeString, setPhpRuntimeEntry } from "../_helpers/_phpRuntimeState.js";
import { isPhpAssocObject } from "../_helpers/_phpTypes.js";
import { getenv } from "../info/getenv.js";
const isLocaleDefinitionMap = (value) => typeof value === 'object' && value !== null && !Array.isArray(value);
const isLocaleCategoryMap = (value) => isPhpAssocObject(value) &&
