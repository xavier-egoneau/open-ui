...
import { get_html_translation_table as getHtmlTranslationTable } from "../strings/get_html_translation_table.js";
export function html_entity_decode(string, quoteStyle) {
    ...
    const hashMapUnknown = getHtmlTranslationTable('HTML_ENTITIES', quoteStyle);
