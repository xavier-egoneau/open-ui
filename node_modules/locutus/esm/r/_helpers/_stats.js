...
export function sortedRNumbers(data, functionName) {
    return [...toRNumericArray(data, functionName)].sort((left, right) => left - right);
}
export function medianOfSorted(values, low = false, high = false) {
    if (values.length === 0) {
        return Number.NaN;
    }
...
export function sampleCovariance(left, right, functionName) {
