...
export function toCalendarInteger(value, functionName) {
...
export function normalizeCalendarYear(value, functionName) {
    return toCalendarInteger(value, functionName);
}
export function normalizeCalendarMonth(value, functionName) {
...
export function normalizeCalendarDay(year, month, value, functionName) {
...
export function normalizeWeekWidth(value, functionName) {
    return toCalendarInteger(value, functionName);
}
export function normalizeFormatColumnWidth(value, functionName) {
    return toCalendarInteger(value, functionName);
}
export function normalizeFormatSpacing(value, functionName) {
    return toCalendarInteger(value, functionName);
}
export function normalizeMonthWidth(value, functionName) {
    return Math.max(toCalendarInteger(value, functionName), 2);
}
export function normalizeLineSpacing(value, functionName) {
    return Math.max(toCalendarInteger(value, functionName), 1);
}
export function normalizeColumnSpacing(value, functionName) {
    return Math.max(toCalendarInteger(value, functionName), 2);
}
export function normalizeMonthsPerRow(value, functionName) {
    return Math.max(toCalendarInteger(value, functionName), 1);
}
export function normalizeTimeTuple(value, functionName) {
...
export function formatWeek(theweek, width) {
...
export function formatString(items, cols = 20, spacing = 6) {
    if (!isIterable(items)) {
...
export function formatMonth(year, month, width, lineSpacing) {
...
export function formatYear(year, width, lineSpacing, columnSpacing, monthsPerRow) {
    const monthWidth = 7 * (width + 1) - 1;
...
export function timeTupleToUnixSeconds(year, month, day, hour, minute, second) {
