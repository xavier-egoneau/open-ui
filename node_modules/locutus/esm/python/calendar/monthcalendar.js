import { buildMonthCalendar, normalizeCalendarMonth, normalizeCalendarYear } from "../_helpers/_calendar.js";
export function monthcalendar(year, month) {
    ...
    return buildMonthCalendar(normalizeCalendarYear(year, 'monthcalendar'), normalizeCalendarMonth(month, 'monthcalendar'));
}
