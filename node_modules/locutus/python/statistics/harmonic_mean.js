...
function harmonic_mean(data, weights) {
    ...
    //       returns 3: 0
    const values = (0, _statistics_ts_1.assertStatisticsArray)(data, 'harmonic_mean').map((value) => (0, _statistics_ts_1.toStatisticNumber)(value, 'harmonic_mean'));
    if (values.length < 1) {
    ...
    const weightValues = weights === undefined
        ? new Array(values.length).fill(1)
        : (0, _statistics_ts_1.assertStatisticsArray)(weights, 'harmonic_mean').map((value) => (0, _statistics_ts_1.toStatisticNumber)(value, 'harmonic_mean'));
