...
exports.toPythonNumber = toPythonNumber;
exports.toPythonInteger = toPythonInteger;
exports.fromPythonInteger = fromPythonInteger;
exports.pythonAbs = pythonAbs;
exports.pythonPos = pythonPos;
exports.pythonNeg = pythonNeg;
exports.pythonTruth = pythonTruth;
exports.pythonNot = pythonNot;
exports.pythonAdd = pythonAdd;
exports.pythonSub = pythonSub;
exports.pythonMul = pythonMul;
exports.pythonTrueDiv = pythonTrueDiv;
exports.pythonFloorDiv = pythonFloorDiv;
exports.pythonMod = pythonMod;
exports.pythonPow = pythonPow;
exports.pythonBitAnd = pythonBitAnd;
exports.pythonBitOr = pythonBitOr;
exports.pythonBitXor = pythonBitXor;
exports.pythonLShift = pythonLShift;
exports.pythonRShift = pythonRShift;
exports.pythonInvert = pythonInvert;
exports.pythonIndex = pythonIndex;
exports.pythonIdentity = pythonIdentity;
exports.pythonEqual = pythonEqual;
exports.pythonCompare = pythonCompare;
exports.pythonConcat = pythonConcat;
exports.pythonContains = pythonContains;
exports.pythonCountOf = pythonCountOf;
exports.pythonIndexOf = pythonIndexOf;
exports.pythonGetItem = pythonGetItem;
...
function pythonAbs(value, functionName) {
    return Math.abs(toPythonNumber(value, functionName));
}
function pythonPos(value, functionName) {
    return toPythonNumber(value, functionName);
}
function pythonNeg(value, functionName) {
    return -toPythonNumber(value, functionName);
}
...
function pythonSub(left, right, functionName) {
    return toPythonNumber(left, functionName) - toPythonNumber(right, functionName);
}
...
function pythonFloorDiv(left, right, functionName) {
    const divisor = toPythonNumber(right, functionName);
    if (divisor === 0) {
