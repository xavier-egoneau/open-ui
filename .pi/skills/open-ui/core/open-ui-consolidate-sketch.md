...
- Ne pas utiliser pour explorer de nouvelles directions : utiliser `/open-ui-sketch`.
- Ne pas utiliser pour une correction ordinaire d'un composant deja canonique : utiliser `/open-ui-modify`.
